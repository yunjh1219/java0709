...
<body>
	...
	<div class="container" style="padding-top: 50;">
		<form method="post" action="${action}">
			...
			<c:if test="${customInfo != null}">  <!-- null이 아닌 경우, 로그인 상태 -->
			<div class="mb-3">
				<label for="writer" class="form-label">작성자 로그인 함</label>
				<input type="text" class="form-control"
					id="writer" name="writer" value="${customInfo.name}" readonly>
			</div>
			</c:if>
			<c:if test="${customInfo == null}">  <!-- null일 경우 로그아웃 상태 -->
			<div class="mb-3">
				<label for="writer" class="form-label">작성자 로그인 안함</label>
				<input type="text" class="form-control"
